...
//
        ...
        Contact snoppy = new Contact("Snoppy");
        Contact archie = new Contact("Archie");

        for (Contact c : List.of(daffy, daisy, last, snoppy)) {
        ...
        for (Contact c : List.of(daffy, daisy, first, archie)) {
            System.out.printf("ceiling(%s)=%s%n", c.getName(), fullSet.floor(c));
            System.out.printf("higher(%s)=%s%n", c.getName(), fullSet.lower(c));
        }
        System.out.println("-".repeat(30));
