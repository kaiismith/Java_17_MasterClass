...
public class Main {
    public static void main(String[] args) {
        ...
        Set<Task> missingTasks = getDifferenence(everyTask, tasks);
        sortAndPrint("Missing Tasks", missingTasks);

        Set<Task> unassignedTasks = getDifferenence(tasks, assignedTasks);
    ...
    private static Set<Task> getDifferenence(Set<Task> a, Set<Task> b) {
